...
uki.more.view.treeList.Render = uki.newClass(uki.view.list.Render, new(function () {
    ...
    this.initStyles = function () {
        ...
        var d = (new uki.theme.Template(".${classPrefix}-row { color: #333; position:relative; padding-top:4px; margin-left: 35px; } .${classPrefix}-toggle { overflow: hidden; position:absolute; left:-15px; top:5px; width: 10px; height:9px; } .${classPrefix}-toggle i { display: block; position:absolute; left: 0; top: 0; width:20px; height:18px; background: url(${imageSrc});} .${classPrefix}-selected { background: url(${backgSrc}); } .${classPrefix}-selected .${classPrefix}-row { color: #FFF; } .${classPrefix}-selected i { left: -10px; } .${classPrefix}-selected-blured { background: url(${backgSrc}); } .${classPrefix}-selected-blured .${classPrefix}-row { color: #FFF; } .${classPrefix}-selected-blured i { left: -10px; } .${classPrefix}-opened i { top: -9px; }")).render({
